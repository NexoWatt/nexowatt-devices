      ...
      try {
        ...
        if (isAlfenAce) {
          ...
          const mode3Code = (v) => {
            ...
            const map = { A: 0, B1: 1, B2: 2, C1: 3, C2: 4, D1: 5, D2: 6, E: 7, F: 8 };
            return Object.prototype.hasOwnProperty.call(map, sMode) ? map[sMode] : undefined;
          };
          ...
          const mode3Text = (v) => {
            ...
            return ({
              A: 'A - No vehicle',
              B1: 'B1 - Vehicle connected, not ready',
              B2: 'B2 - Vehicle connected, ready/no charging',
              C1: 'C1 - Vehicle connected, no PWM charging',
              C2: 'C2 - Charging',
              D1: 'D1 - Vehicle connected, ventilation required, no charging',
